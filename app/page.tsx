...
const HormonesFoodGuide = () => {
  ...
  const emotionRegulatingHormones = {
    negativeEmotions: [
      {
    ...
    otherHormones: [
      ...
      },
      {
        title: "Testosterone",
        subtitle:
          "Regulates male characteristics, muscle mass, and bone density",
        foods: [
          {
            name: "Olive oil",
            benefit:
  ...
  const allHormones = [
    ...emotionRegulatingHormones.negativeEmotions,
    ...emotionRegulatingHormones.positiveEmotions,
    ...emotionRegulatingHormones.otherHormones,
  ];
  ...
  const filteredHormones = allHormones.filter(
    (hormone) =>
      ...
      hormone.foods.some(
        (food: { name: string; benefit: string }) =>
      ...
      {searchTerm ? (
        ...
        <>
          <div className="mb-6">
            ...
            {emotionRegulatingHormones.negativeEmotions.map(
              (hormone, index) => (
                <HormoneAccordion
                  key={index}
                  number={index + 1}
          ...
          <div className="mb-6">
            ...
            {emotionRegulatingHormones.positiveEmotions.map(
              (hormone, index) => (
                <HormoneAccordion
                  key={index}
                  number={index + 1}
          ...
          <div className="mb-6">
            <h2 className="text-xl font-semibold mb-4 flex items-center text-blue-700">
              <Info className="mr-2 hidden sm:inline" /> Other Important
              Hormones
            </h2>
            <p className="mb-4 text-gray-600">
              These hormones play crucial roles in various bodily functions. The
              foods listed can help support their balance and overall hormonal
              health.
            </p>
            {emotionRegulatingHormones.otherHormones.map((hormone, index) => (
              <HormoneAccordion
                key={index}
                number={index + 1}
                title={hormone.title}
